...
var/global/list/start_landmarks_list = list()			//list of all spawn points created
var/global/list/department_security_spawns = list()	//list of all department security spawns
