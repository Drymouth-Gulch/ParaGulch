					...
					New()
						switch(rand(1,10))//get a random num between 1 and 10 inside a switch proc set the ifs bellow that
							...
							if(5)
								...
								del src
							if(6)
								var/obj/item/clothing/suit/storage/fr_jacket/lb = new //used to be surgical apron - todo: move over
								lb.loc=src.loc
								del src
							if(7)
				...
				wasteland //1.5
					...
					meds
						New()
							switch(rand(1,4))
								if(1)
									var/obj/item/weapon/reagent_containers/food/pill/patch/healpowder/lb = new
									lb.loc=src.loc
									del src
								if(2)
									var/obj/item/weapon/storage/pill_bottle/radx/lb = new
						...
						New()
							switch(rand(1,10))
								...
								if(3)
									...
									del src
								if(4)
									var/obj/item/weapon/gun/projectile/automatic/l6_saw/lb = new
									lb.loc=src.loc
									del src
								if(5)
									var/obj/item/weapon/gun/projectile/automatic/sniper_rifle/lb = new
									lb.loc=src.loc
									del src
								if(6)
								...
								if(7)
									...
									del src
								if(8)
									var/obj/item/weapon/gun/energy/shock_revolver/lb = new
									lb.loc=src.loc
									del src
								if(9)
							...
							New()
								switch(rand(1,6))
									...
									if(3)
										...
										del src
									if(4)
										var/obj/item/weapon/storage/box/buck/lb = new
										lb.loc=src.loc
										del src
									if(5)
							...
							New()
								switch(rand(1,10))
									...
									if(5)
										...
										del src
									if(6)
										var/obj/item/weapon/storage/box/slug/lb = new
										lb.loc=src.loc
										del src
									if(7)
							...
							New()
								switch(rand(1,16))
									...
									if(12)
										...
										del src
									if(13)
										var/obj/item/weapon/storage/box/dragonsbreath/lb = new
										lb.loc=src.loc
										del src
									if(14)
