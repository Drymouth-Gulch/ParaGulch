/*This file contains medicine containers i.e. the item.
This file contains:
...
/obj/item/weapon/reagent_containers/stimpak/attack_animal(mob/user)
...
/obj/item/weapon/reagent_containers/stimpak/attack(mob/living/M, mob/user)
	...
	if(reagents.total_volume && (ignore_flags || M.can_inject(user, 1))) // Ignore flag should be checked first or there will be an error message.
		...
		reagents.reaction(M, SYRINGE_INJECT, fraction)
		if(M.reagents)
