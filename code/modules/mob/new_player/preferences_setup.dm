...
/// TODO - READD ALL THE BITS I JUST RIPPED OUT TO MAKE THIS NICE AND SHINY - GOMBLE
/datum/preferences/proc/update_preview_icon()
	...
	if(job_wasteland_low & WASTELAND)
		previewJob = job_master.GetJob("Wastelander")
...
//	preview_icon.Scale(48+32, 16+32)
	...
	mannequin.dir = WEST
	preview_icon_side = getFlatIcon(mannequin)

	mannequin.dir = SOUTH
	preview_icon_front = getFlatIcon(mannequin)
